...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* XVIC features */
        {"xvic", "masternode", &masternode, true, true, false},
        {"xvic", "listmasternodes", &listmasternodes, true, true, false},
        {"xvic", "getmasternodecount", &getmasternodecount, true, true, false},
        {"xvic", "masternodeconnect", &masternodeconnect, true, true, false},
        {"xvic", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"xvic", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"xvic", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"xvic", "masternodecurrent", &masternodecurrent, true, true, false},
        {"xvic", "masternodedebug", &masternodedebug, true, true, false},
        {"xvic", "startmasternode", &startmasternode, true, true, false},
        {"xvic", "createmasternodekey", &createmasternodekey, true, true, false},
        {"xvic", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"xvic", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"xvic", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"xvic", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"xvic", "getmasternodescores", &getmasternodescores, true, true, false},
        {"xvic", "mnbudget", &mnbudget, true, true, false},
        {"xvic", "preparebudget", &preparebudget, true, true, false},
        {"xvic", "submitbudget", &submitbudget, true, true, false},
        {"xvic", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"xvic", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"xvic", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"xvic", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"xvic", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"xvic", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"xvic", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"xvic", "checkbudgets", &checkbudgets, true, true, false},
        {"xvic", "mnsync", &mnsync, true, true, false},
        {"xvic", "spork", &spork, true, true, false},
        {"xvic", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzxvicseed", &getzxvicseed, false, false, true},
        {"zerocoin", "setzxvicseed", &setzxvicseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzxvic", &searchdzxvic, false, false, true},
        {"zerocoin", "dzxvicstate", &dzxvicstate, false, false, true}
...
{
    return "> xvic-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17600/\n";
}
