...
extern UniValue setzxvicseed(const UniValue& params, bool fHelp);
extern UniValue getzxvicseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzxvic(const UniValue& params, bool fHelp);
extern UniValue dzxvicstate(const UniValue& params, bool fHelp);
