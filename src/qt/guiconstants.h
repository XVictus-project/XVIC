...
/* XVIC GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "XVIC"
#define QAPP_ORG_DOMAIN "xvic.org"
#define QAPP_APP_NAME_DEFAULT "XVIC-Qt"
#define QAPP_APP_NAME_TESTNET "XVIC-Qt-testnet"
