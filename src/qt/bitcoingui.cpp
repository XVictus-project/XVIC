                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("XVIC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a XVIC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and xvic: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zXVIC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About XVIC Core"), this);
    aboutAction->setStatusTip(tr("Show information about XVIC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for XVIC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your XVIC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified XVIC addresses"));
    ...
    openAction->setStatusTip(tr("Open a XVIC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gentaium Core help message to get a list with possible XVIC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("XVIC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to XVIC network", "", count));
}
...
{
    QString strTitle = tr("XVIC Core"); // default title
