...
// Copyright (c) 2015-2018 The XVIC developers
                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzXVICPathCustom = GetArg("-zxvicbackuppath", "");
    ...
    if(!strzXVICPathCustom.empty()) {
        ui->wallet_customzxvicbackuppath->setText(QString::fromStdString(strzXVICPathCustom));
        ui->wallet_customzxvicbackuppath_label->setVisible(true);
        ui->wallet_customzxvicbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzXVICPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the XVIC RPC console.") + "<br>" +
