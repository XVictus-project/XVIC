...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("XVIC Core xvic-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  xvic-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xvic transaction") + "\n" +
                               "  xvic-tx [options] -create [commands]   " + _("Create hex-encoded xvic transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded xvic transaction
