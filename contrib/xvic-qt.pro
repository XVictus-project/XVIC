...
RESOURCES += src/qt/xvic.qrc src/qt/xvic_locale.qrc

TRANSLATIONS += src/qt/locale/xvic_bg.ts \
                src/qt/locale/xvic_de.ts \
                src/qt/locale/xvic_en.ts \
                src/qt/locale/xvic_es.ts \
                src/qt/locale/xvic_fi.ts \
                src/qt/locale/xvic_fr.ts \
                src/qt/locale/xvic_it.ts \
                src/qt/locale/xvic_ja.ts \
                src/qt/locale/xvic_pl.ts \
                src/qt/locale/xvic_pt.ts \
                src/qt/locale/xvic_ru.ts \
                src/qt/locale/xvic_sk.ts \
                src/qt/locale/xvic_sv.ts \
                src/qt/locale/xvic_vi.ts \
                src/qt/locale/xvic_zh_CN.ts \
                src/qt/locale/xvic_zh_TW.ts
