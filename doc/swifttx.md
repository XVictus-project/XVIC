...
This mechanism has been integrated into Bitcore-Node-XVIC which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/XVictus-project/insight-api-xvic#web-socket-api](https://github.com/XVictus-project/insight-api-xvic#web-socket-api) 
* API: [https://github.com/XVictus-project/insight-api-xvic#swifttx-transactions](https://github.com/XVictus-project/insight-api-xvic#swifttx-transactions) 
...
By default, the XVIC Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the XVIC Core daemon:
