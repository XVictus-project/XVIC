...
In order to support loading of multiple wallets in xvic-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is xvic.cpp.
...
Changes to xvic.cpp
----------------------
xvic.cpp is the entry point into xvic-qt, and as such, will require some minor modifications to provide hooks for
