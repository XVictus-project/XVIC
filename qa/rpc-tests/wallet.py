...
#   c) node1 mines 32 blocks, so now node 0 has 60001xvic, node 1 has 4250xvic, node2 has none.
#   d) node0 sends 601 xvic to node2, in two transactions (301 xvic, then 300 xvic).
