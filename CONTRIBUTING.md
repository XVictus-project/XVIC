Contributing to XVIC Core
============================

The XVIC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the XVIC Core project, and is not to be
confused with overall XVIC Network Protocol consensus changes.

Whether a pull request is merged into XVIC Core rests with the project merge
...
Patches that change XVIC consensus rules are considerably more involved than
...
Where a patch set proposes to change the XVIC consensus, it must have been
...
The project leader is the release manager for each XVIC Core release.
